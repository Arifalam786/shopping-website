  ...
  return (
    <div className="cont">
      <div className="log">
        ...
        <div className="input">
          <input type="text" name="" id="" placeholder="name" className="inp-item"/>
          <input type="text" name="" id="" placeholder="name" className="inp-item"/>
          <input type="text" name="" id="" placeholder="name" className="inp-item"/>
          <input type="text" name="" id="" placeholder="name" className="inp-item"/>
          <input type="text" name="" id="" placeholder="name" className="inp-item"/>
      ...
      <div className="payment">
        ...
        <div className="pay-meth">
          <div className="meth">
            <div className="metha">
          <img src={props.inpost} alt="" className="payment-icon" id="phone"/> $769
          </div>
          </div >
          <div className="meth">
          <div className="metha">
          <img src={props.blue} alt="" className="payment-icon" id="phone"/> $369
          </div>
         </div >
          <div className="meth">
          <div className="metha">
          <img src={props.delhi} alt="" className="payment-icon" id="delhi"/> $669
          </div>
         </div >
          <div className="meth">
          <div className="metha">
          <img src={props.fed} alt="" className="payment-icon" id="phone"/> $269
          </div>
         </div >
        </div>
      </div>
      <div className="cart">
        ...
        <div className="price">
          <p className="pricea">Total cost    <span>$99.99</span></p>
        </div>
        <div className="total-price">
            ...
            <div className="info-item">
                <p>You are <span>$798</span> away <br></br>from free delivery</p>
            </div>
        </div>
      </div>
    </div>
